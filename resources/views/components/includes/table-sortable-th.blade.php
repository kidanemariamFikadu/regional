<th scope="col" class="px-6 py-3 flex items-center cursor-pointer" wire:click="setSortBy('{{ $name }}')">
    <span>{{ $displayName }}</span>
    @if ($sortBy !== $name)
        <svg class="w-5 h-5 ml-2 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
