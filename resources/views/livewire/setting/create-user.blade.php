        ...
        <flux:fieldset>
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-4 gap-y-6">
                <div class="space-y-6 col-span-1">
                    ...
                    <flux:input wire:model="phone_number" label="{{ __('Phone number') }}" type="tel" name="phone_number"
                        badge="Required" />
                    ...
                    <flux:input wire:model="password" label="{{ __('Password') }}" type="password" name="password"
                        badge="Required" />
                    <flux:input wire:model="password_confirmation" label="{{ __('Retype Password') }}" type="password"
                        name="password_confirmation" badge="Required" />
